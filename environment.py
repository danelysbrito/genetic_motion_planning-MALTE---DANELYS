...
class MaklinkGraph:
    ...
    def dijkstra(self):
        ...
        # Calcula y imprime el tiempo que tardó Dijkstra
        end_time = time.time()
        dijkstra_time = end_time - start_time
        print(f"Tiempo Dijkstra: {dijkstra_time} segundos")
        print("=======================================================")
...
# =================================== visualization ============================================
    ...
    def visualize_environment(self, solution=None, draw_dijkstra_path = False, show_or_save = False, filename="test.png", algorithm=None):
        fig, ax = plt.subplots()
        ...
        plt.title(f"Maklink Motion Planning - {algorithm}" if algorithm else "Maklink Motion Planning")
        plt.xlabel("X-axis")
        plt.ylabel("Y-axis")
